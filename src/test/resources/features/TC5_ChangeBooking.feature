...
Scenario Outline: verifying change Booking module by changing checkInDate for created for created orderID
  ...
  Given User is in OmrBranch hotel page
    ...
    When User edit the booking by changing the checkInDate
    ...
    | durai8827@gmail.com | NPTIneyveli@3  |2024-03-02  |
    ...
    When User edit the booking by changing the checkInDate
    Then User should verify after editing success message "Booking updated successfully" 
    And User should verify the oderID after editing oldorderID present successfully
